...
const ExpandableText = ({ text, maxLength = 100 }) => {
    ...
    return (
      <Box display="flex" flexDirection="column">
        ...
        {isLongText && (
          <Button size="sm" variant="plain" onClick={() => setIsExpanded(!isExpanded)}>
...
export const Item = ({ name, title, description, price, photo_url }: { name: string, title: string, description: string, price: number, photo_url: string }) => {
